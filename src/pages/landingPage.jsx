...
const Section = ({ children, className = "", id, dark = false }) => (
    <section
        id={id}
        className={`relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 scroll-mt-24 ${dark ? "bg-[#0d1117]" : "bg-white"} ${className}`}
    >
                    ...
                    >
                        {businesses.map((biz, i) => (
                            <motion.div
                                ...
                                onClick={() => {
                                    if (biz.websiteName) navigate(`/${biz.websiteName}`);
                                }}
                            >
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex items-start justify-between gap-3 mb-3">
                                        <div className="flex items-center gap-3 min-w-0">
                                            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center text-xl shrink-0 group-hover:scale-110 transition-transform duration-300">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <motion.span
                                            className="inline-flex items-center gap-1 text-blue-600 text-sm font-semibold group-hover:gap-2 transition-all"
                                            whileHover={{ x: 2 }}
                                        >
                                            View Inventory
...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0d1117] overflow-x-hidden">
            ...
            {/* ══════════════════  HERO  ══════════════════ */}
            <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-[#0d1117]">
                {/* Ambient glow */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-24 pb-12">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[70vh]">
                        ...
                        >
                            ...
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] tracking-tight font-['Space_Grotesk']">
                                Smart Inventory{" "}
            ...
            <Section id="categories" className="bg-gray-50">
                ...
                >
                    {CATEGORIES.map((cat, i) => (
                        <motion.div
                            key={i}
                            className="group relative bg-white rounded-2xl p-6 border border-gray-100 hover:border-indigo-200 transition-all duration-300 cursor-default"
                            variants={fadeInUp}
                            custom={i}
                            whileHover={{ y: -8, boxShadow: "0 20px 50px rgba(0,0,0,0.08)" }}
                        >
                            <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${cat.gradient} flex items-center justify-center text-2xl mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                {cat.icon}
                            </div>
            ...
            <Section id="features" ref={refServices}>
                ...
                >
                    {FEATURES.map((f, i) => (
                        <motion.div
                            key={i}
                            className="group relative bg-white rounded-2xl p-6 border border-gray-100 hover:border-indigo-200 transition-all duration-300"
                            variants={fadeInUp}
                            custom={i}
                            whileHover={{ y: -6, boxShadow: "0 20px 50px rgba(0,0,0,0.08)" }}
                        >
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-100 to-blue-100 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                                {f.icon}
                            </div>
